...
new_params = HParams(activation_func="relu", # or elu or leaky relu?
                ...
                which_scheduler="smith exp range", # "custom_scheduler_epoch-cap1_exp-0.7_epsilon1e-10", #"step-6-13--0.5",# "custom_scheduler_epoch-cap4_exp-0.5_epsilon1e-6", # manually adjust this; only for logging
                early_stopping=True,
