...
use_batch_norm = ['True']
l2regs = [1e-2, 1e-4, 1e-5, 1e-6]
dropouts = [0, 1e-2, 0.3]
decays = [0, 1e-2, 0.2, 0.3]
...
satellite = "Landsat8"
cls_list=[['fill', 'shadow', 'clear', 'thin', 'cloud' ], ['shadow', 'clear', 'thin', 'cloud' ]]  # [['clear', 'cloud', 'shadow', 'snow', 'water']] # [['clear', 'cloud', 'thin', 'shadow']] 
train_set = "Biome_gt"
                                        ...
                                        for initializer in initializers:
                                            for cls in cls_list:
                                                if loss_func == "sparse_categorical_crossentropy":
                                                    cls = get_cls(satellite, train_set, cls)
