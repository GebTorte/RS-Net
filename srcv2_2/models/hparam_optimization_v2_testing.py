...
# depending on model input, fill might be a good idea in each class
...
for train_dataset in train_datasets:
    ...
    for train_overlap in train_overlaps:
        for overlap in overlaps:
            ...
            params = HParams(train_dataset=train_dataset, test_dataset=train_dataset,overlap=overlap, overlap_train_set=train_overlap, satellite=satellite, split_dataset=split_flag)
                                                                        ...
                                                                        for norm_threshold in norm_thresholds_dummy:
                                                                            for cls in cls_list:
                                                                                ...
                                                                                params = HParams(activation_func=activation_func,
                                                                                                ...
                                                                                                overlap=overlap,
                                                                                                overlap_train_set=train_overlap,
