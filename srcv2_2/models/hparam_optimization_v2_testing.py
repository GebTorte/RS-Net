...
satellite = "Landsat8"
gt_cls_list=[['shadow', 'clear', 'thin', 'cloud'], ['clear', 'cloud']] #['fill','shadow', 'clear', 'thin', 'cloud'],  # [['clear', 'cloud', 'shadow', 'snow', 'water']] # [['clear', 'cloud', 'thin', 'shadow']] 
...
for train_dataset in train_datasets:
    ...
    for train_overlap in train_overlaps:
        for overlap in overlaps:
            params = f"--params=\"train_dataset={train_dataset};overlap_train_set={train_overlap};overlap={overlap};satellite={satellite}\""
